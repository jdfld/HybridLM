...
from fla.layers.utils import get_unpad_data, pad_input
...
class DeltaNet(nn.Module):
    ...
    Args:
        ...
        qk_norm (str, Optional):
            The normalization method for the query and key. Default: `l2`.r
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if use_short_conv: # Not a big fan of this? Kinda better to apply somewhere else no?
            self.conv_size = conv_size
